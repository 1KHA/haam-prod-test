...
export default function AcceleratorDashboard() {
  ...
  const quickActions = [
    { name: "إكمال الملف الشخصي", path: "/accelerator-dashboard/profile", icon: <Users className="h-4 w-4 ml-2" /> },
    { name: "إضافة أعضاء الفريق", path: "/accelerator-dashboard/team", icon: <Users className="h-4 w-4 ml-2" /> },
    { name: "التقديم للبرامج", path: "/accelerator-dashboard/apply", icon: <Rocket className="h-4 w-4 ml-2" /> },
    { name: "البحث عن موجهين", path: "/accelerator-dashboard/mentors", icon: <BookOpen className="h-4 w-4 ml-2" /> },
    { name: "استكشاف الموارد", path: "/accelerator-dashboard/resources", icon: <FileText className="h-4 w-4 ml-2" /> },
    { name: "التسجيل في الفعاليات", path: "/accelerator-dashboard/events", icon: <Calendar className="h-4 w-4 ml-2" /> },
  ]
              ...
              <div className="space-y-4">
                <div className="pr-4 py-2" style={{ borderRight: "4px solid #f58f62" }}>
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <Button size="sm" onClick={() => router.push("/accelerator-dashboard/apply/1")}>
                      تقديم طلب
                    </Button>
                  </div>
                </div>
                <div className="pr-4 py-2" style={{ borderRight: "4px solid #799dd7" }}>
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <Button size="sm" onClick={() => router.push("/accelerator-dashboard/apply/2")}>
                      تقديم طلب
                    </Button>
                  </div>
                </div>
                <div className="pr-4 py-2" style={{ borderRight: "4px solid #3f4249" }}>
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <Button size="sm" onClick={() => router.push("/accelerator-dashboard/apply/3")}>
                      تقديم طلب
                    </Button>
                  </div>
                </div>
            ...
            <CardContent>
              <div className="space-y-6">
                {upcomingEvents.map((event) => (
                  <div key={event.id} className="pr-4 py-2" style={{ borderRight: "4px solid #f58f62" }}>
                    ...
                    <div className="flex justify-between mt-2">
                      ...
                      <Button size="sm" onClick={() => router.push(`/accelerator-dashboard/events/${event.id}`)}>
                        التسجيل
                      </Button>
                    </div>
                  </div>
                ...
                <div className="flex justify-center mt-4">
                  <Button variant="outline" onClick={() => router.push("/accelerator-dashboard/events")}>
                    عرض جميع الفعاليات
                  </Button>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="pr-4 py-2" style={{ borderRight: "4px solid #799dd7" }}>
                  ...
                  <div className="flex justify-end mt-2">
                    <Button size="sm" variant="outline" onClick={() => router.push("/accelerator-dashboard/resources/1")}>
                      تحميل الدليل
                    </Button>
                  </div>
                </div>
                <div className="pr-4 py-2" style={{ borderRight: "4px solid #f58f62" }}>
                  ...
                  <div className="flex justify-end mt-2">
                    <Button size="sm" variant="outline" onClick={() => router.push("/accelerator-dashboard/resources/2")}>
                      تحميل القالب
                    </Button>
                  </div>
                </div>
                <div className="pr-4 py-2" style={{ borderRight: "4px solid #3f4249" }}>
                  ...
                  <div className="flex justify-end mt-2">
                    <Button size="sm" variant="outline" onClick={() => router.push("/accelerator-dashboard/resources/3")}>
                      بدء الدورة
                    </Button>
                  </div>
                </div>
                <div className="flex justify-center mt-4">
                  <Button variant="outline" onClick={() => router.push("/accelerator-dashboard/resources")}>
                    عرض جميع الموارد
                  </Button>
                </div>
              </div>
