...
export default function EntrepreneurNotificationsPage() {
  ...
  const acceptedCount = notifications.filter(n => 
    n.type === "application" && 
    n.title.includes("تهانينا") && 
    !n.isRead
  ).length
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p>لا توجد إشعارات</p>
              <p className="text-sm mt-2">ستظهر هنا إشعارات المهام وتحديثات طلباتك</p>
            </div>
          ) : (
            <div className="space-y-3">
              {filteredNotifications.map((notification) => {
                const priorityStyle = priorityConfig[notification.priority]
                const isAccepted = notification.title.includes("تهانينا") || notification.title.includes("Congratulations")
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                          ...
                          <h3 className={cn("font-semibold text-lg", isAccepted && "text-green-700 dark:text-green-300")}>
                            {notification.title}
                          </h3>
                          {/* Priority Badge */}
