...
const priorityConfig: Record<string, { color: string; label: string }> = {
  high: { color: "bg-red-500 text-white", label: "عالي" },
  medium: { color: "bg-yellow-500 text-white", label: "متوسط" },
  low: { color: "bg-blue-500 text-white", label: "منخفض" },
}
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        {/* Priority Badge */}
                        <Badge className={priorityConfig[notification.priority]?.color || "bg-gray-500"}>
